    ...
    @if (Auth::user()->hasRole('user'))
        <div class="mt-8 max-w-7xl mx-auto flex">
            <div class="w-1/3 sm:px-6 lg:px-8">
                <p style="font-family: 'Nunito'; font-size: 18pt; font-weight: bold; margin: 0px !important;">Dashboard</p>
            </div>
            <div class="w-2/3 sm:px-6 lg:px-8">
                <button class="float-right bg-green-400 px-3 py-2 font-semibold tracking-wider text-white rounded-full hover:bg-green-500" data-bs-toggle="modal" data-bs-target="#startWorkingModal" style="font-family: 'Nunito'; font-size: 12pt;">
                    <!-- Start working -->
                    მუშაობის დაწყება
                </button>
                <button class="flex float-right bg-blue-400 mx-3 px-3 py-2 font-semibold tracking-wider text-white rounded-full hover:bg-blue-500" data-bs-toggle="modal" data-bs-target="#startWorkingModal" style="font-family: 'Nunito'; font-size: 12pt;">
                    <!-- Pause -->
                    დაპაუზება
                ...
                <button class="float-right bg-red-400 mx-3 px-3 py-2 font-semibold tracking-wider text-white rounded-full hover:bg-red-500" data-bs-toggle="modal" data-bs-target="#startWorkingModal" style="font-family: 'Nunito'; font-size: 12pt;">
                    <!-- Finish -->
                    დასრულება
                </button>
            </div>
                    ...
                    <div class="p-6 bg-white border-b border-gray-200">
                        ...
                        <div class="mt-14" style="width: 100%;">
                            <div class="my-3 px-3 message-div" style="width: 250px; border-radius: 20px; display: flex;">
                                ...
                                <p class="py-2 message-text" style="font-family: 'Nunito'; font-size: 14pt; font-weight: bold; margin: 0px !important; line-height: 1.5rem;">
                                    <!-- messages -->
                                    მიმოწერა
                                </p>
                            </div>
            ...
            <div class="w-2/3 sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 bg-white border-b border-gray-200">
                        ...
                        <p style="font-family: 'Nunito'; font-size: 18pt; font-weight: bold;">
                            <!-- Projects -->
                            პროექტები
                        </p>
                        ...
                        <div class="px-2 mt-3" style="width: 100%; height: 200px; display: flex;">
                            <div class="border-1 border-green-600 my-3 mr-3 shadow-md bg-gray-50 transform duration-700 hover:-translate-y-4 cursor-pointer" style="width: 130px; height: 130px; border-radius: 10px;">
                                ...
                                <p style="font-family: 'Nunito'; font-size: 10pt; font-weight: bold; text-align: center; color: #34D399; margin-top: 20px;">
                                    <!-- Active -->
                                    აქტიური
                                </p>
                            </div>
                            ...
                            <div class="my-3 mx-3 shadow-md bg-gray-50 transform duration-700 hover:-translate-y-4 cursor-pointer" style="width: 130px; height: 130px; border-radius: 10px;">
                                ...
                                <p style="font-family: 'Nunito'; font-size: 10pt; font-weight: bold; text-align: center; color: #EF4444; margin-top: 20px;">
                                    <!-- Finished -->
                                    დასრულებული
                                </p>
                            </div>
                            ...
                            <div class="my-3 mx-3 shadow-md bg-gray-50 transform duration-700 hover:-translate-y-4 cursor-pointer" style="width: 130px; height: 130px; border-radius: 10px;">
                                ...
                                <p style="font-family: 'Nunito'; font-size: 10pt; font-weight: bold; text-align: center; color: #6B7280; margin-top: 20px;">
                                    <!-- Archived -->
                                    დაარქივებული
                                </p>
                            </div>
